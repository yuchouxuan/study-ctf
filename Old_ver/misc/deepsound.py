...
def is_magic(buf):
    ...
    return (buf[0] & 15)  == (68 >> 4) and (buf[2]  & 15) == (68 & 15)     and (buf[4] & 15)  == (83 >> 4) and (buf[6]  & 15) == (83 & 15)     and (buf[8] & 15)  == (67 >> 4) and (buf[10] & 15) == (67 & 15)     and (buf[12] & 15) == (70 >> 4) and (buf[14] & 15) == (70 & 15)
